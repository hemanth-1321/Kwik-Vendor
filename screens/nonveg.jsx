...
const NonVeg = () => {
  ...
  const images = [
    {
      source: require('../assets/chickenbiriyani.png'),
      label: 'Chicken Biriyani',
      price: '₹ 110',
    },
    {
      source: require('../assets/mutton.png'),
      label: 'Mutton Biriyani',
      price: '₹ 220',
    },
    {
      source: require('../assets/friedrice.png'),
      label: 'Chicken Fried Rice',
      price: '₹ 70',
    },
    {
      source: require('../assets/tandoorichicken.png'),
      label: 'Tandoori',
      price: '₹ 240',
    },
    {
      source: require('../assets/kabab.png'),
      label: 'Kabab',
      price: '₹ 50',
    },
  ];
