          ...
          <View style={styles.buttonsContainer}>
            <View style={styles.buttonWrapper}>
              <Pressable
                ...
                onPress={() => navigation.navigate('VegCater')}
              >
                <Image source={require('../assets/vegcater.png')} style={styles.buttonImage} />
                <Text style={styles.buttonText}>Veg Catering Services</Text>
              </Pressable>
            </View>
            ...
            <View style={styles.buttonWrapper}>
              <Pressable
                style={styles.imageButton}
                onPress={() => navigation.navigate('NonVegCater')}
              >
                <Image source={require('../assets/noncater.png')} style={styles.buttonImage} />
                <Text style={styles.buttonText}>NON-VEG CAtering Services</Text>
              </Pressable>
            </View>
          </View>
